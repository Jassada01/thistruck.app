...
<head>
    <title>อัพโหลด Product Master</title>
    <meta charset="utf-8" />
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">อัพโหลด Product Master</h1>
                                <!--end::Title-->
                                <!--begin::Separator-->
                                ...
                                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                                    ...
                                    <li class="breadcrumb-item text-dark">อัพโหลด Product Master</li>
                                </ul>
                                <!--end::Breadcrumb-->
                                <!--end::Breadcrumb-->
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="col-sm-9 mt-3 d-flex align-items-center px-3">
                                            <h1><i class="bi bi-upload fs-3"></i></i> อัพโหลด Product Master</h1><a href="assets/media/template_file/product_master_template.csv" class="btn btn-sm btn-light-info ms-3"><i class="fa fa-file"></i> Template File</a>
                                        </div>
                ...
                $("#upload").on("change", function(e) {
                    ...
                    Papa.parse(file, {
                        ...
                        complete: function(results) {
                            ...
                            // กรองข้อมูลที่ item_code = null ออก
                            uploadResult = uploadResult.filter(item => item.item_code !== null);

                            // แปลง item_desc ที่เป็น null เป็น ""
                            uploadResult = uploadResult.map(item => ({
                                ...item,
                                item_desc: item.item_desc === null ? "" : item.item_desc
                            }));
                            var table = $("<table>");
