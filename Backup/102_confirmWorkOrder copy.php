                            ...
                            <div class="row gy-5 g-xl-8">
                                                    ...
                                                    <div data-repeater-item>
                                                        ...
                                                        <div class="form-group row mb-2">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <label class="form-label">หมายเลขตู้</label>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <select class="form-control mb-2 mb-md-0 truckType" name="truckType">
                                                                            ...
                                                                            // Query data from master_data where type = 'Job_Type'
                                                                            $sql = "SELECT * FROM master_data where type = 'Truck_Type' order by id;";
                                                                            $result = mysqli_query($conn, $sql);
                                ...
                                <div class="card">
                                    <div class="card-header mt-3">
                                        ...
                                        <div class="col-sm-6 mt-3 d-none text-end">
                                            <!-- ปุ่มเพิ่มสถานที่ -->
                                    ...
                                    <div class="form-group mt-3 row">
                                        ...
                                        <div class="col-sm-8">
                                            <select type="text" class="form-control m-input" id="job_characteristic" name="job_characteristic" data-dropdown-parent="#addLocationModal">
                                                ...
                                                // Query data from master_data where type = 'Job_Type'
                                                $sql = "SELECT * FROM master_data WHERE type = 'job_characteristic'";
                                                $result = mysqli_query($conn, $sql);
                ...
                $.ajax({
                    ...
                    .done(function(retunrdata) {
                        ...
                        $.each(data_arr, function(index, val) {
                            show_name = val.location_name;

                            if (val.location_type == "ลูกค้า") {
                                show_name = val.customer_name + "(" + val.branch + ")" + " - " + val.location_name;
                            }
            ...
            $('body').on('click', '#btnAddNewLocation', function() {
                if (checkInputsNewLocation()) {
                    ...
                    if (TEMP_MAIN_DATA.location_type == "ลูกค้า") {
                        ...
                        TEMP_MAIN_DATA['showName'] = TEMP_MAIN_DATA.location_name;
                    ...
                    $.ajax({
                        ...
                        .done(function(data) {
                            ...
                            Swal.fire({
                                ...
                                // Redirect to jobOrderTemplateDetail page with jobTemplateID parameter
                                //window.location.href = `102_confirmWorkOrder.php?job_id=${data}`;
                            });
            ...
            function loadJobdata() {
                ...
                $.ajax({
                    ...
                    .done(function(data) {
                        ...
                        // วนลูปใน JobDetailTrip
                        $.each(data_arr.JobDetailTrip, function(i, item) {
                            // เพิ่ม element ใน DriverList
                            $('#DriverList').find('[data-repeater-create]').click();

                            // ดึง element ล่าสุดของ DriverList
                            var lastDriver = $('#DriverList').find('.form-group [data-repeater-item]').last();

                            // กำหนดค่าของ input field ใน lastDriver จาก item ของ JobDetailTrip
                            lastDriver.find('.truckinJob').val(item.truck_id).trigger('change');
                            lastDriver.find('.truckDriver').val(item.driver_id).trigger('change');
                            lastDriver.find('.containerID').val(item.containerID);
                            lastDriver.find('.sealNo').val(item.seal_no);
                            lastDriver.find('.containerWeight').val(item.containerWeight);
                            lastDriver.find('.subcontrackCheckbox').prop('checked', item.subcontrackCheckbox == 1);
                            lastDriver.find('.containersize').val(item.containersize).trigger('change');
                            lastDriver.find('.truckType').val(item.truckType).trigger('change');
                            lastDriver.find('.jobStartDateTime').val(item.jobStartDateTime);
                        });
