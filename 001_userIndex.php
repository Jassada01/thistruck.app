                        ...
                        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                                ...
                                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                                    ...
                                    <!--begin::Item-->
                                    <li class="breadcrumb-item text-dark">ข้อมูลผู้ใช้งานระบบ</li>
                                    <!--end::Item-->
                                </ul>
                                <!--end::Breadcrumb-->
                                <!--end::Breadcrumb-->
                            ...
                            <div class="d-flex align-items-center py-1">
                                ...
                                <a href="002_createUser.php" class="btn btn-sm btn-primary"> <i class="fa fa-plus"></i> เพิ่มผู้ใช้งานระบบ</a>
                                <!--end::Button-->
                            </div>
                            <!--end::Actions-->
                        </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="col-sm-9 mt-3 d-flex align-items-center px-3">
                                            <h1><i class="fa fa-user-tie fs-3"></i> ข้อมูลผู้ใช้งานระบบ</h1>
                                        </div>
                                            ...
                                            <table class="table table-bordered table-hover table-striped w-100 d-none" id="locationTable">
                                                <thead class="bg-primary text-white">
                                                    <tr>
                                                        ...
                                                        <th class="font-weight-bold text-center">ตำแหน่ง</th>
                                                        <th class="font-weight-bold text-center">ระดับผู้ใช้งาน</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    if ($inactive) {
                                                        $sql = "Select a.*, b.name as adminLevel From users a Inner Join master_data b ON a.user_level = b.value AND b.type = 'user_level'  Order By a.id";
                                                    } else {
                                                        $sql = "Select a.*, b.name as adminLevel From users a Inner Join master_data b ON a.user_level = b.value AND b.type = 'user_level' Where a.active = 1 Order By a.id";
                                                    }
                                                    ...
                                                    while ($row = mysqli_fetch_array($result)) {
                                                        ...
                                                        echo "<tr>";
                                                        echo "<td class='text-center'>  " . $row['name']. $nonActive  . "</td>";
                                                        echo "<td class='text-center'>" . $row['position_name'] . "</td>";
                                                        echo "<td class='text-center'>" . $row['adminLevel'] . "</td>";
                                                        echo "<td  class='text-center'><a href=\"003_userDetail.php?uid=" . $row['id'] . "\"><button type=\"button\" class=\"btn btn-sm btn-secondary\">ดูรายละเอียด</button></a></td>";
                                                        echo "</tr>";
                                                    }
        ...
        $(document).ready(function() {
            ...
            $('#active').change(function() {
                if ($(this).is(":checked")) { // ถ้าถูกติ๊ก
                    window.location.href = '001_userIndex.php'; // รีโหลดหน้าเว็บพร้อมกับส่งพารามิเตอร์ ?inactive=true
                } else { // ถ้าไม่ถูกติ๊ก
                    window.location.href = '001_userIndex.php?inactive=true'; // รีโหลดหน้าเว็บพร้อมกับส่งพารามิเตอร์ ?inactive=true
                }
            });
